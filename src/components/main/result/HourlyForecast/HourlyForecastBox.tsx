  ...
  const getIcon = () => {
    ...
    switch (true) {
      case weatherCode === 0:
        return (
          <img
            src={isDay ? sunnyIcon : overcastIcon}
      ...
      case weatherCode === 1 || weatherCode === 2:
        return (
          <img
            src={isDay ? partlyCloudyIcon : overcastIcon}
            className={styles.icon_img}
            alt="partly cloudy"
          />
        );
      ...
      case weatherCode === 3:
        return (
          <img src={overcastIcon} className={styles.icon_img} alt="overcast" />
        );
      ...
      case weatherCode >= 51 && weatherCode <= 57:
        return (
          <img src={drizzleIcon} className={styles.icon_img} alt="drizzle" />
        );
      ...
      case weatherCode >= 80 && weatherCode <= 82:
        return (
          <img src={rainIcon} className={styles.icon_img} alt="rain showers" />
        );

      case weatherCode >= 85 && weatherCode <= 86:
        return (
          <img src={snowIcon} className={styles.icon_img} alt="snow showers" />
        );

      case weatherCode >= 95:
        return (
          <img src={stormIcon} className={styles.icon_img} alt="thunderstorm" />
        );
  ...
  return (
    <div className={styles.hourly_forecast_box_container}>
      ...
      <div className={styles.hourly_forecast_box_right}>
        <p className={styles.hourly_forecast_box_temp_text}>
          {hourlyTempCalculation()}°
        </p>
      </div>
    </div>
  );
